...
using ClassFabric.Core.Controls.NotificationTemplates;
using ClassFabric.Core.Helpers.UI;
using ClassFabric.Core.Models.Notification.Templates;
using CommunityToolkit.Mvvm.ComponentModel;
using Google.Protobuf.WellKnownTypes;

namespace ClassFabric.Core.Models.Notification;
