...
using ClassInfo = ClassFabric.Shared.Models.Profile.ClassInfo;
using Profile = ClassFabric.Shared.Models.Profile.Profile;
using Subject = ClassFabric.Shared.Models.Profile.Subject;

namespace ClassFabric.Shared.Extensions;
...
public static class CsesExtensions
{
    ...
    /// <summary>
    /// 将 CSES 格式的课表转换为 ClassFabric 格式的课表。
    /// </summary>
    /// <param name="profile">CSES 格式课表</param>
    /// <param name="mergeProfile">需要合并的 ClassFabric 课表</param>
    /// <returns>ClassFabric 格式课表</returns>
    public static Profile ToClassFabricObject(this CsesSharp.Models.Profile profile, Profile? mergeProfile=null)
    {
    ...
    /// <summary>
    /// 将 ClassFabric 格式的课表转换为 CSES 格式的课表。
    /// </summary>
    /// <param name="profile">ClassFabric 格式课表</param>
