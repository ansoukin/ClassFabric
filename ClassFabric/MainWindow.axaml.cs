...
using ClassFabric.Core.Extensions.UI;
...
using ClassFabric.Shared.Interfaces.Controls;
...
public partial class MainWindow : Window, ITopmostEffectPlayer
{
    ...
    public const string DefaultFontFamilyKey =
        "avares://ClassFabric/Assets/Fonts/#HarmonyOS Sans SC, avares://ClassFabric.Core/Assets/Fonts/#FluentSystemIcons-Resizable";
...
#pragma warning disable CS8974 // 将方法组转换为非委托类型
        TutorialService.Context["classfabric.mainWindow.hasComponentWithSettings"] = HasComponentWithSettings;
        TutorialService.Context["classfabric.mainWindow.hasContainerComponent"] = HasContainerComponent;
#pragma warning restore CS8974 // 将方法组转换为非委托类型
...
#endif
        TutorialService.BeginNotCompletedTutorials("classfabric.getStarted.welcome/init");
    }
    ...
    private void ViewModelOnPropertyChanged(object? sender, PropertyChangedEventArgs e)
    {
        ...
        {
            TutorialService.Context["classfabric.mainWindow.editMode.isComponentsSelected"] =
                ViewModel.SelectedComponentSettings != null;
            TutorialService.Context["classfabric.mainWindow.editMode.selectedComponent.hasSettings"] =
                ViewModel.SelectedComponentSettings is { AssociatedComponentInfo.SettingsType: not null };
            TutorialService.Context["classfabric.mainWindow.editMode.selectedComponent.isContainer"] =
    ...
    {
        SetBottom();
        // 直接监听窗口属性变化并设置鼠标穿透可能导致死循环/栈溢出，故我们在用户点到 ClassFabric 窗口时设置这个。
        UpdateWindowFeatures();
    }
    ...
    private async void EnterEditMode()
    {
        ...
        TutorialService.PushToNextSentenceByTag("classfabric.mainwindow.editMode.enter");
        if (ManagementService.Policy.DisableSettingsEditing)
        {
            return;
        }
        TutorialService.BeginNotCompletedTutorials(
            "classfabric.getStarted.componentsEditing/introduction",
            "classfabric.getStarted.componentsEditing/addComponent");
        if (HasComponentWithSettings())
        {
            TutorialService.BeginNotCompletedTutorials(
                "classfabric.getStarted.componentsEditing/componentSettings");
        }
        if (HasContainerComponent())
        {
            TutorialService.BeginNotCompletedTutorials(
                "classfabric.getStarted.componentsEditing/containerComponent");
        }
        TutorialService.BeginNotCompletedTutorials("classfabric.getStarted.componentsEditing/mainWindowLine");
    }
    ...
    private void ExitEditMode()
    {
        ...
        TutorialService.PushToNextSentenceByTag("classfabric.mainwindow.editMode.exit");
    }
    ...
    private void SelectorComponents_OnSelectionChanged(object sender, SelectionChangedEventArgs e)
    {
        ...
        {
            TutorialService.PushToNextSentenceByTag("classfabric.mainwindow.editMode.selection.changed");
        });
    }
    ...
    private void ButtonNewMainWindowLine_OnClick(object? sender, RoutedEventArgs e)
    {
        ...
        TutorialService.PushToNextSentenceByTag("classfabric.mainwindow.editMode.mainWindowLine.create");
    }
