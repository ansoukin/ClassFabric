...
using ClassFabric.Controls.Tutorial;
...
public partial class TutorialService : ObservableObject, ITutorialService
{
        ...
        IUriNavigationService uriNavigationService, ILogger<TutorialService> logger, IManagementService managementService)
    {
        ...
        Context["classfabric.management.policy.getDisableProfileClassPlanEditing"] = () => ManagementService.Policy.DisableProfileClassPlanEditing;
        Context["classfabric.management.policy.getDisableProfileTimeLayoutEditing"] = () => ManagementService.Policy.DisableProfileTimeLayoutEditing;
        Context["classfabric.management.policy.getDisableProfileSubjectsEditing"] = () => ManagementService.Policy.DisableProfileSubjectsEditing;
        Context["classfabric.management.policy.getDisableProfileEditing"] = () => ManagementService.Policy.DisableProfileEditing;
        Context["classfabric.management.policy.getDisableSettingsEditing"] = () => ManagementService.Policy.DisableSettingsEditing;
        Context["classfabric.management.policy.getDisableSplashCustomize"] = () => ManagementService.Policy.DisableSplashCustomize;
        Context["classfabric.management.policy.getDisableDebugMenu"] = () => ManagementService.Policy.DisableDebugMenu;
        Context["classfabric.management.policy.getAllowExitManagement"] = () => ManagementService.Policy.AllowExitManagement;
        Context["classfabric.management.policy.getDisableEasterEggs"] = () => ManagementService.Policy.DisableEasterEggs;

        if (SettingsService.WillMigrateInitTutorial)
        {
            SetIsTutorialCompleted("classfabric.getStarted.welcome/init", true);
        }
    }
    ...
    private void StartSentence(TutorialSentence sentence)
    {
        ...
        var targetControl = !string.IsNullOrWhiteSpace(sentence.TargetSelector)
            ...
            : null;
        var heroContent = !string.IsNullOrWhiteSpace(sentence.HeroImage) ? new AdvancedImage(new Uri("avares://ClassFabric/"))
        {
