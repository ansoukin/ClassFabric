...
using ClassFabric.Core.Enums.Metadata.Announcement;
using ClassFabric.Core.Models.Metadata.Announcement;
using ClassFabric.Helpers;
using ClassFabric.Shared.Helpers;
using CommunityToolkit.Mvvm.ComponentModel;
using Microsoft.Extensions.Logging;

namespace ClassFabric.Services.Metadata;
...
public class AnnouncementService : ObservableRecipient, IAnnouncementService
{
    ...
    public async Task RefreshAnnouncements()
    {
        try
        {
            ...
            AnnouncementsInternal =
                await WebRequestHelper.Default.SaveJson<ObservableCollection<Announcement>>(new Uri($"https://get.classisland.tech/d/ClassIsland-Ningbo-S3/classfabric/announcements.json?time={time}"), Path.Combine(CommonDirectories.AppCacheFolderPath,
