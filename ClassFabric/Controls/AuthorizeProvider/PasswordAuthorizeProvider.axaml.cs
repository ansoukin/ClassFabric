...
using ClassFabric.Models.AuthorizeProviderSettings;

namespace ClassFabric.Controls.AuthorizeProvider;

/// <summary>
/// PasswordAuthorizeProvider.xaml 的交互逻辑
/// </summary>
[AuthorizeProviderInfo("classfabric.authProviders.password", "密码", "\uec8b")]
