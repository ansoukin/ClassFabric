...
using ClassFabric.Views.WelcomePages;
using DynamicData;
...
public partial class WelcomeWindow : MyWindow, INavigationPageFactory
{
    ...
    {
        var startupPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.Startup), "ClassFabric.lnk");
        var startMenuPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.StartMenu), "ClassFabric.lnk");
        var desktopPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.DesktopDirectory), "ClassFabric.lnk");
    ...
    private async Task CreateShortcutsFreedesktop()
    {
        ...
        var startMenuPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile),
            ".local/share/applications/cn.classfabric.app.desktop");
        var desktopPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.DesktopDirectory), "ClassFabric.desktop");
