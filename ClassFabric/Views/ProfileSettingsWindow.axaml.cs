...
using ClassFabric.Controls.ScheduleDataGrid;
...
public partial class ProfileSettingsWindow : MyWindow
{
    ...
    private void OnDrawerStateChanged()
    {
        ...
        {
            ViewModel.TutorialService.PushToNextSentenceByTag("classfabric.profileSettingsWindow.drawer.close");
        }
    }
    ...
    public async void Open(Uri? uri = null)
    {
                ...
                })
            {
                Dispatcher.UIThread.Post(() =>
                {
                    if (ViewModel.ProfileService.Profile.TimeLayouts.Count > 0)
                    {
                        ...
                        {
                            ViewModel.TutorialService.BeginNotCompletedTutorials("classfabric.getStarted.profileEditing/setup-classplans");
                        }
                        ...
                        {
                            ViewModel.TutorialService.BeginNotCompletedTutorials("classfabric.getStarted.profileEditing/multiweek-classplans");
                        }
                    }
                    else
                    {
                        ViewModel.TutorialService.BeginNotCompletedTutorials(
                            "classfabric.getStarted.profileEditing/concepts",
                            "classfabric.getStarted.profileEditing/setup-timeLayout");
                    }
                });
            }
        }
        ...
        ViewModel.TutorialService.PushToNextSentenceByTag("classfabric.profileSettingsWindow.open");
    ...
    private async void ButtonCreateProfile_OnClick(object sender, RoutedEventArgs e)
    {
        ...
        var subject =
            await new StreamReader(AssetLoader.Open(new Uri("avares://ClassFabric/Assets/default-subjects.json",
    ...
    private void ButtonAddTimeLayout_OnClick(object sender, RoutedEventArgs e)
    {
        ...
        ViewModel.TutorialService.PushToNextSentence("classfabric.getStarted.profileEditing/setup-timeLayout");
    }
